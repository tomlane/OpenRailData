...
{
    public class ChangeOfIdentityRepository : BaseRepository<ChangeOfIdentityEntity>, IChangeOfIdentityRepository
    {
        ...
        public Task InsertMultipleRecordsAsync(IEnumerable<ChangeOfIdentity> records)
        {
            if (records == null)
                throw new ArgumentNullException(nameof(records));

            var entites = records.Select(_mapper.Map<ChangeOfIdentityEntity>).ToList();
